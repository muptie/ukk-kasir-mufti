...
if (!$pelanggan) { setAlert('danger', 'Pelanggan tidak ditemukan!'); redirect('/kedaimupti/admin/pelanggan/'); }
            ...
            <div class="content-card" style="max-width: 600px;">
                ...
                <form method="POST">
                    ...
                    <div style="display: flex; gap: 12px; margin-top: 24px;">
                        ...
                        <a href="/kedaimupti/admin/pelanggan/" class="btn btn-danger" style="flex: 1;"><i class="fas fa-times"></i> Batal</a>
                    </div>
                </form>
            </div>
        </main>
