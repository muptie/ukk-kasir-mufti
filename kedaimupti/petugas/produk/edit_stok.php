...
if (!$produk) { setAlert('danger', 'Produk tidak ditemukan!'); redirect('/kedaimupti/petugas/produk/'); }

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $stok_baru = (int)$_POST['stok'];
    if (mysqli_query($conn, "UPDATE produk SET Stok = '$stok_baru' WHERE ProdukID = '$id'")) {
    ...
    <div class="dashboard-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="content-card" style="max-width: 600px;">
                <div class="card-header"><h3 class="card-title"><i class="fas fa-edit"></i> Form Edit Stok</h3></div>
                ...
                <form method="POST">
                    ...
                    <div style="display: flex; gap: 12px; margin-top: 24px;">
                        <button type="submit" class="btn btn-primary" style="flex: 1;"><i class="fas fa-save"></i> Update Stok</button>
                        <a href="/kedaimupti/petugas/produk/" class="btn btn-danger" style="flex: 1;"><i class="fas fa-times"></i> Batal</a>
                    </div>
                </form>
            </div>
        </main>
